...
import 'package:krish_biz/pricecalculator.dart';
...
class SelectCalculateRegion extends StatefulWidget {
  @override
  _SelectCalculateRegionState createState() => _SelectCalculateRegionState();
}

class _SelectCalculateRegionState extends State<SelectCalculateRegion> {
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              PriceCalculator(state: statesData[index]),
                        ),
                      );
                    },
                  ),
